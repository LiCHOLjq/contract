        ...
        <el-col :span="24">
          ...
          <div class="ms-login">
            <el-form :model="form" label-width="0px" class="demo-ruleForm">
              ...
              <h1>新闻内容</h1>
              <el-row>
                <editor v-model="news.html" ref="editerCenter" @contentData="onEditorChange($event)"></editor>
              </el-row>
              <el-row class="auto-table">
                <p v-if="!isAdd">
              ...
              <el-row class="auto-table">
                <el-form-item>
                  ...
                  <el-button v-if="!isAdd&&news.newsState == 'news_state_open'&&news.canReturn" icon="el-icon-refresh-left" @click="privateNews" type="danger">撤回新闻</el-button>
                  <el-button v-if="!isAdd&&news.newsState == 'news_state_close'" icon="el-icon-delete" @click="handelDelNews" type="danger">删除新闻</el-button>
                </el-form-item>
              </el-row>
            </el-form>
          </div>
...
export default {
  ...
  methods: {
    ...
    publicNews() {
      this.$confirm('发布后新闻内容将不能再修改，您确定发布此条新闻吗？', '提示', {
        confirmButtonText: '确定',
        cancelButtonText: '取消',
        type: 'warning'
      }).then(() => {
