...
CREATE TABLE `agreement`  (
  ...
  `agreement_amount` varchar(50) CHARACTER SET utf8 COLLATE utf8_general_ci NULL DEFAULT NULL COMMENT '总金额',
...
INSERT INTO `power` VALUES ('p_02_01', '合同管理', '/home/agreement', 2, 'p_02', 'el-icon-document');
